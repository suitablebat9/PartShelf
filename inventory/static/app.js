...
document.querySelector('#label-component')?.addEventListener('change',e=>{const option=e.target.selectedOptions[0];document.querySelector('#label-text').value=option.dataset.name+'\n'+option.dataset.identifier});
